...
let artistByIndex = getArtistByIndex(artists, 1);
...
function lotsOfArt(artistArray) {
  ...
  for (let index = 0; index < artistArray.length; index++) {
    if (artistArray[index].paintings > 100) {
      newArray.push(artistArray[index].name)
    }
  }
...
function artistInfo(artistArray, name) {
  for (let index = 0; index < artistArray.length; index++) {
    if (artistArray[index].name === name) {
      return artistArray[index].bio
    }
  }
}
...
function artistByCountry(artistArray, nationality) {
  ...
  for (let index = 0; index < artistArray.length; index++) {
    if (artistArray[index].nationality === nationality) {
      if (artistArray[index].nationality.split(',').length === 1) {
        newArray.push(artistArray[index].name)
      }

      console.log('split', artistArray[index].nationality.split(','))
    }
  }
